...
from ..modreq_model import ModReqE
import re
...
def get_modreqs(uid=None, status=None, username=None):
    ...
    modreqs_data = ModReqE.objects(**query)
...
class ModReq_E(Resource):
    ...
    @require_api_key(access_tokens=['modreq.e'])
    def get(self):
    ...
    def post(self):
        ...
        modreq = ModReqE(username=username, request=request, location=location, status="open").save()

        return {'modreq': construct_modreq_data(modreq)}


class ModReq_E_Claim(Resource):
    post_parser = RequestParser()
    ...
    def post(self):
        ...
        modreq = ModReqE.objects(uid=uid).first()
...
class ModReq_E_UnClaim(Resource):
    post_parser = RequestParser()
    post_parser.add_argument("id", type=int, required=True)
...
rest_api.add_resource(ModReq_E, '/modreq/e')
rest_api.add_resource(ModReq_E_Claim, '/modreq/e/claim')
rest_api.add_resource(ModReq_E_UnClaim, '/modreq/e/unclaim')
rest_api.add_resource(ModReq_E_Done, '/modreq/e/done')

register_api_access_token("modreq.e", permission="api.modreq.e")
